...
/**
 * Interface for reading a keyword-value dictionary containing objects of various types.
...
public interface IProperties {
	 ...
	 *   A key.
	 * @return
	 *   The value associated with {@code key}. Return {@code null} if the key in question was not found.
	 */
	 ...
	 *   A default value.
	 * @return
	 *   The value associated with {@code key}. Return {@code defaultVal} if the key in question was not found.
	 */
	public Object get(String key, Object defaultVal);
	
	/**
	 * Request the value associated with the specified key. The type restriction is enforced.
	 * @param key
	 *   A key.
	 * @param type
	 *   A value type.
	...
	/**
	 * Request the value associated with the specified key. The type restriction is enforced, but defaulting is allowed.
	 * @param key
	 *   A key.
	 * @param type
	 *   A value type.
	 * @return
	 *   The value associated with {@code key}, 
	 * @throws BadConfigurationException
	 *   The key exists, but its value could not be cast to {@code type}.
	 */
	 ...
	 */
	public long getTimeMillis(String key, long defaultVal) throws BadConfigurationException;
