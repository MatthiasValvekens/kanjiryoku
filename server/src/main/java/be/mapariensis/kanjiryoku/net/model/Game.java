...
public enum Game {
	TAKINGTURNS {
		@Override
		public GameServerInterface getServer(IProperties config, KanjiGuesser guesser, ProblemSetManager psets)
			...
			return new TakingTurnsServer(psets.getProblemSets(seed, names),guesser,batonPass);
		};
	...
	public abstract GameServerInterface getServer(IProperties config, KanjiGuesser guesser, ProblemSetManager psets) throws UnsupportedGameException, ServerBackendException, BadConfigurationException;
}
